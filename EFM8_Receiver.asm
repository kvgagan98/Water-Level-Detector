...
; y = 89.327x + 2.0764 x=Cap,y=height in %
...
display_c:
    ...
    mov y+2, #0
    mov y+3, #0
    lcall mul32 ; x has Rtotal * frequency
    Load_y(10000) ; frequency/10000
    lcall div32
    mov y+0,x+0
    mov y+1,x+1
    mov y+2,x+2
    mov y+3,x+3
    Load_x(1440000000) 
    lcall div32 ; x = c displayed
	; multiply by 89.327 = 89327
	; add 2
	; divide by 1000
	lcall hex2bcd
...
hex2bcd_L0_freq:
    ...
    rlc a      ; multiply by 2
    mov TL0, a ; multiplied result in here
	...
	djnz R3, hex2bcd_L0_freq ; decrement and jump if not 0
	ret
